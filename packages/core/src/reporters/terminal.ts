 ...
 */
export function renderTerminalReport(report: AuditReport): void {
  ...
  Object.entries(report.summary.bySeverity).forEach(([sev, count]) => {
    let sevColor = "37";
    if (sev === "critical") sevColor = "31";
    else if (sev === "serious") sevColor = "33";
    else if (sev === "moderate") sevColor = "35";
    else if (sev === "minor") sevColor = "36";
        ...
        issue.severity === "critical"
          ...
          : issue.severity === "serious"
            ...
            : issue.severity === "moderate"
              ...
              : "36";
      console.log(
        `${color(sevColor, `[${issue.severity.toUpperCase()}]`)} ${issue.message} (${issue.category})`,
      );
