 ...
 */
export async function auditBestPractices(page: BrowserPage): Promise<{
  issues: Issue[];
  passed: PendingCheck[];
}> {
  const issues: Issue[] = [];
 ...
 */
function checkDoctype(page: BrowserPage): Issue | null {
 ...
 */
function checkCharset(page: BrowserPage): Issue | null {
  const document = page.document;
 ...
 */
function checkHtmlLang(page: BrowserPage): Issue | null {
  const document = page.document;
 ...
 */
function checkDeprecatedElements(page: BrowserPage): Issue[] {
  const issues: Issue[] = [];
  const document = page.document;
 ...
 */
function checkDuplicateIds(page: BrowserPage): Issue[] {
  const issues: Issue[] = [];
  const document = page.document;
 ...
 */
function checkBrokenImages(page: BrowserPage): Issue[] {
  const issues: Issue[] = [];
  const document = page.document;
 ...
 */
function checkLinks(page: BrowserPage): Issue[] {
  const issues: Issue[] = [];
  const document = page.document;
 ...
 */
function checkMetaRefresh(page: BrowserPage): Issue | null {
  const document = page.document;
 ...
 */
function checkVulnerableLibraries(page: BrowserPage): Issue[] {
  const issues: Issue[] = [];
  const document = page.document;
 ...
 */
function checkPasswordPaste(page: BrowserPage): Issue[] {
  const issues: Issue[] = [];
  const document = page.document;
 ...
 */
function checkIntrusivePermissions(page: BrowserPage): Issue[] {
  const issues: Issue[] = [];
  const document = page.document;
